    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-2xl relative z-20">
      ...
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">
          Únete a la comunidad del Cine ULEAM
        </p>
      </div>
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3 text-sm">
            <label for="terms" class="text-gray-600 cursor-pointer">
              Acepto los 
              <a href="#" class="font-medium text-[#8B0000] hover:text-[#A52A2A]">términos y condiciones</a>
              y la 
              <a href="#" class="font-medium text-[#8B0000] hover:text-[#A52A2A]">política de privacidad</a>
            </label>
          </div>
        </div>
        ...
        <div class="text-center">
          <p class="text-sm text-gray-600">
            ...
            <router-link to="/login" class="font-medium text-[#8B0000] hover:text-[#A52A2A] transition duration-200">
              Inicia sesión aquí
            </router-link>
          </p>
        </div>
